#include "service_copy_dnote_disk_to_data.h"


CServiceCopyDNoteDiskToDataThread::CServiceCopyDNoteDiskToDataThread()
{
...
void CServiceCopyDNoteDiskToDataThread::setListDataService   (CListDataService *_list_data_service)
{
    m_list_data_service = _list_data_service;
}

void CServiceCopyDNoteDiskToDataThread::setTreeWidget (QTreeWidget *_tree_widget)
{
    m_tree_widget = _tree_widget;
}

void CServiceCopyDNoteDiskToDataThread::setStop (bool _stop)
{
    m_stop = _stop;
}


void  CServiceCopyDNoteDiskToDataThread::slotFileChanged(const QString & )
{
   //m_refresh = true;
}

void CServiceCopyDNoteDiskToDataThread::run()
{
    while (m_stop == false)
    {
        CListDataPlugin *list_data_plugin = m_list_data_service->getListDataPlugin(INFORMATIONS_CONNECTIONS_SETTINGS , "NAME_PLUGIN" , "Plugin D-Note Disk");
...
CServiceCopyDNoteDiskToData::CServiceCopyDNoteDiskToData()
{
    m_start = false;
    m_thread = new CServiceCopyDNoteDiskToDataThread;
...
void CServiceCopyDNoteDiskToData::init (CListDataService *_list_data_informations)
{
...
QObject *CServiceCopyDNoteDiskToData::getObject()
{
    return this;
}

QString CServiceCopyDNoteDiskToData::getNameService()
{
    return "service copy tablette tactile";
}


void CServiceCopyDNoteDiskToData::createWidget ()
{
...
void CServiceCopyDNoteDiskToData::initWidget()
{
    m_tree_widget->clear();
...
void CServiceCopyDNoteDiskToData::updateWidget()
{
    for (int i=0 ;  i < m_list_data_service->count() ; i++)
    {
        if (m_list_data_service->index(i,INFORMATIONS_CONNECTIONS_SETTINGS).getValueData("NAME_PLUGIN").toString() == "Plugin D-Note Disk")
        {
...
QWidget * CServiceCopyDNoteDiskToData::getWidget()
{
    return m_widget;
}

QString CServiceCopyDNoteDiskToData::getDescriptionService()
{
    return "copie les fichiers de la tablette tactile vers le répertoire data";
}

void CServiceCopyDNoteDiskToData::start ()
{
...
void CServiceCopyDNoteDiskToData::stop()
{
    m_start = false;
    m_thread->setStop(true);
}

void CServiceCopyDNoteDiskToData::save (QDomDocument &_dom_document , QDomElement &_dom_element)
{
...
void CServiceCopyDNoteDiskToData::load (QDomDocument & , QDomElement &_dom_element)
{
...
void CServiceCopyDNoteDiskToData::slotUpdate()
{
    updateWidget();
    start();
}
...
Q_EXPORT_PLUGIN2(serviceCopyDNoteDiskToData , CServiceCopyDNoteDiskToData)
